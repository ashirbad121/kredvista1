...
public class ListenerImplementation implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		...
		//It adds the name of the test method in the test ng report
	...
	public void onTestFailure(ITestResult result) {
		String methodName=result.getMethod().getMethodName();
		//get the system date 
		String screenshotName=methodName+ new JavaUtils().systemDateInFormat();
		
		
		try {
			String screenshotPath=WebDriverUtils.getScreenshot(BaseClass.sdriver, screenshotName);
			
			//screenshot will be added in the extent report from the path 
		...
		//print the failed report status with method name in extent report
	...
	public void onStart(ITestContext context) {
		...
		//give reporter name
		report.setSystemInfo("Reporter", "Ashirbad");
	}
